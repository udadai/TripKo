...
const PlacePoster = ({
  ...
  return (
    <div className="place-card relative flex-shrink-0 overflow-hidden">
      <Link
        to={to ? to : "/"}
        className="shadow-rounded-card relative flex flex-shrink-0 flex-col justify-between gap-1 p-2 md:w-[15rem]"
      >
